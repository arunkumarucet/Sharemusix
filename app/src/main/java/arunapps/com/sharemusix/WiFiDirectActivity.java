...
public class WiFiDirectActivity extends AppCompatActivity implements ChannelListener, DeviceActionListener {
    ...
    public static final String TAG = "wifidirectsharemusix";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            arglist[1] = pref.getString("devicename", Build.MODEL);
    ...
    public void showDetails(WifiP2pDevice device) {
        DeviceDetailFragment fragment = (DeviceDetailFragment) getFragmentManager()
                .findFragmentById(R.id.frag_detail);
        fragment.connect_method(device);
    }
