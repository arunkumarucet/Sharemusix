 ...
 * [Album.OnFragmentInteractionListener] interface
...
class Album : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        view1=inflater!!.inflate(R.layout.fragment_album, container, false)
    ...
    fun loadcardview() {
        ...
        val myAdapter = AlbumCardAdapter(context, db.getAllAlbum(0),db.getAllAlbum(1),db.getAllAlbum(2))
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): Album {
            val fragment = Album()
            val args = Bundle()
